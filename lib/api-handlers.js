...
const { buildCommoditiesDashboard } = require("./commodities-engine");
    ...
    if (method === "GET" && pathname === "/api/commodities/dashboard") {
      ...
      try {
        ...
        return json(200, wrapResponse({
          ...
          contracts: [],
          strategies: [],
          message: err.message || "Commodities desk could not load futures quotes",
        }, { source: "Yahoo", dataType: "unavailable", confidence: 0 }));
      }
    }
