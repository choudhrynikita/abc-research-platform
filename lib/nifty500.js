...
async function buildNifty500Dashboard() {
  ...
  return {
    marketOverview: {
      ...
      sampleUniverse: true,
      note: `NIFTY 500 index via Yahoo Finance ^CRSLDX; constituent breadth uses a ${constituentsMeta.length}-stock reference sample (not full index). Nifty 50 included for context.`,
