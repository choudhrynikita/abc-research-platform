...
function snapshotFields(ipo, card) {
  ...
  return [
    ...
    { label: "Price source", value: snap.priceSource === "NSE bid ladder" ? "NSE bid ladder — SME issue-info page is empty" : null },
    ...
    { label: "Fresh issue", value: snap.freshLabel || ipo.issueBreakdown?.freshLabel || null },
    { label: "Offer for sale", value: snap.ofsLabel || ipo.issueBreakdown?.ofsLabel || null },
