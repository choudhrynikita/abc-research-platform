...
module.exports = pack({
  ...
  "indices-04": {
    lead: "Bank Nifty is a concentrated financials book. It is not 'Nifty but banks'. Fewer names, fatter tails, a different options microstructure, and a different RBI-day personality. Treating BN weeklies like Nifty weeklies is how accounts vanish on a policy Thursday.",
    ...
    blocks: [
      { t: "p", text: "If private-bank heavyweights hiccup together, Bank Nifty can move 2% while Nifty moves 0.7%. That extra torque is why BN weeklies pay more premium and why they also confiscate more. Your shock cell on a BN condor cannot be a copy-paste of the Nifty cell." },
      { t: "table", caption: "Nifty vs Bank Nifty (desk habits)", headers: ["Lens", "Nifty", "Bank Nifty"], rows: [
        ...
        ["Typical weekly personality", "Pin + dealer gamma", "Fatter tails, event clustering"],
    ...
    takeaways: ["BN is a sector book with index clothing.", "Widen the shock cell or don't trade BN weeklies.", "RBI day is BN's weather."],
  ...
  "intraday-07": {
    ...
    blocks: [
      { t: "p", text: "On a normal Tuesday, 14:30–15:20 is where you reduce, not invent. On expiry Thursday, it is a specialist session: dealer hedges, max-pain folklore, and genuine delta to cover. Pick a role before 14:00. 'I'll see' at 15:10 is how weeklies become a tax." },
    ...
    quiz: { q: "Starting a fresh Nifty weekly directional at 15:12 on a normal Tuesday is usually:", options: ["Smart use of theta", "Trading inventory without a written role", "A cash-and-carry", "Required"], answer: 1, why: "The last minutes are not discovery." },
  },
  "intraday-08": {
    lead: "Expiry Thursday (or whichever weekday NSE has assigned to the weekly) is a named session with its own playbook: pin risk, exploding gamma, and a 15:00 personality that does not exist on Tuesday. If you treat it as 'just another day with more premium', you are the premium.",
  ...
  "rates-04": {
    ...
    quiz: { q: "Expressing a 12-month NIM view in a 2-day Bank Nifty weekly credit is:", options: ["Precise", "A horizon mismatch — weeklies are gamma, not NIM", "Required", "A cash-and-carry"], answer: 1, why: "Contain the view in the product." },
  },
  "rates-05": {
  ...
  "rates-10": {
    ...
    quiz: { q: "Sizing a Bank Nifty weekly into MPC with a blank rates dashboard is:", options: ["Discretion", "Flying without the weather sheet", "A cash-and-carry", "Required"], answer: 1, why: "BN is rates-adjacent — the sheet is the job." },
  },
