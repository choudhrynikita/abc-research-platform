...
module.exports = pack({
  ...
  "regulations-02": {
    ...
    blocks: [
      { t: "table", caption: "Know the buckets (rates change — verify)", headers: ["Item", "Lives on"], rows: [["STT", "Securities transaction tax — delivery vs F&O differ"], ["Stamp duty", "State-linked, typically buy side for equities"], ["Exchange / clearing / SEBI fees", "Turnover"], ["GST", "On brokerage and certain services"], ["DP charges", "When shares leave demat on a sell"]] },
      { t: "p", text: "Zero-brokerage ads do not zero the rest. Compute round-trip on a real contract note once. Then decide if scalping 4 ticks is a job or a donation." },
    ],
  ...
  "desk-01": {
    ...
    blocks: [
      { t: "p", text: "Example: 'If Nifty weekly is a range and IV is elevated, I sell a defined-risk condor sized to 1R max loss, no adds, time-stop Friday 14:00 unless a 1.5× ATR shock hits the wing plan.' That is a playbook line. 'I like Bank Nifty' is not." },
    ],
