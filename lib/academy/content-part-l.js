...
module.exports = pack({
  ...
  "macro-08": {
    ...
    blocks: [
      { t: "p", text: "Nifty options do not trade at 2am IST. The Fed does. Your Thursday weekly can gap Friday morning. If you sell Friday-expiry premium on a Fed Wednesday, you sold a press conference you cannot hedge in size at 2:15am. Either size the gap or don't sell that expiry." },
    ...
    quiz: { q: "Selling a Thursday Nifty weekly through a FOMC night is mainly:", options: ["Free theta", "Unhedgeable gap risk during your market's close", "Required", "A cash-secured put"], answer: 1, why: "You are closed; they are not." },
  },
  "macro-09": {
  ...
  "systems-09": {
    ...
    blocks: [
      { t: "p", text: "If weekly expiry style changes, a Thursday theta system is a new animal. If STT on options jumps (it did in 2024 and 2026), short-vol expectancy must be recomputed, not 'felt'. Retire, retune on a new sample, or reduce. Do not pray." },
    ],
  ...
  "options-14": {
    lead: "Weekly expiry as a game: pin, charm, dealer inventory, and the last two hours. If you do not have a role — pin participant, fade the scramble, or flat — Thursday afternoon will assign you one.",
    ...
    blocks: [
      ...
      { t: "example", title: "Role card", body: "Flat by 14:30 unless I am a defined-risk pin butterfly sized to 0.4R, kill at 15:20. That is a Thursday. 'Let's see if it pins' is not." },
    ],
    takeaways: ["Pick a Thursday role.", "Pain is not a duty.", "Don't size in the scramble."],
