...
module.exports = pack({
  ...
  "volatility-05": {
    ...
    blocks: [
      { t: "p", text: "A classic Nifty calendar: short this Thursday 24,100 CE, long next month 24,100 CE, net debit. If the week is quiet, the short decays and the long holds value. If Nifty rips 400 points, both calls go ITM; the short can hurt more than the long helps in the first hours because of gamma. Calendars are not 'safe theta'. They are a view on time and on not being run over." },
      { t: "callout", kind: "india", title: "Weekly expiry is the whole point", text: "India's weekly index options make calendars a native product. They also make them a trap: every Thursday is a potential explosion. If your calendar assumes a sleepy week, check the economic calendar like an adult." },
  ...
  "volatility-07": {
    ...
    blocks: [
      { t: "p", text: "A Thursday-expiry Nifty weekly has almost no weekend inside it. A monthly that spans Republic Day does. If you sell theta into a three-day weekend because 'theta loves weekends', you sold jump risk cheap. Sometimes you get paid. That is not a process." },
  ...
  "volatility-10": {
    ...
    blocks: [
      { t: "p", text: "People remember the 18 quiet Thursdays. The market remembers the 19th. Size so the 19th is a scar, not an eviction. That is the entire advanced lesson, dressed in Greeks." },
