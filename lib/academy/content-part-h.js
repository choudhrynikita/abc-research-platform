...
module.exports = pack({
  ...
  "positioning-08": {
    ...
    blocks: [
      ...
      { t: "callout", kind: "india", title: "Tuesday / Thursday", text: "Nifty weekly expiry packs gamma into a few sessions. A structure that was a sleepy 15-day condor is a gamma event if you still hold it into the last 48 hours. Roll, wing it, or size it as a day job." },
    ],
