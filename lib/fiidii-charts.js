...
function aggregateHistory(history, granularity) {
  ...
  return [...buckets.values()]
    ...
    .map((b) => ({
      date: b.date,
      // Preserve verified zeros — never coerce 0 → null.
      fiiNet: b.hasFii ? Number(b.fiiNet.toFixed(2)) : null,
      diiNet: b.hasDii ? Number(b.diiNet.toFixed(2)) : null,
      fiiBuy: b.hasFiiBuy ? Number(b.fiiBuy.toFixed(2)) : null,
      fiiSell: b.hasFiiSell ? Number(b.fiiSell.toFixed(2)) : null,
      diiBuy: b.hasDiiBuy ? Number(b.diiBuy.toFixed(2)) : null,
      diiSell: b.hasDiiSell ? Number(b.diiSell.toFixed(2)) : null,
      grossBuy: b.hasFiiBuy && b.hasDiiBuy ? Number((b.fiiBuy + b.diiBuy).toFixed(2)) : null,
      grossSell: b.hasFiiSell && b.hasDiiSell ? Number((b.fiiSell + b.diiSell).toFixed(2)) : null,
