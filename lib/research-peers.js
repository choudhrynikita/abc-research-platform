  ...
  try {
    ...
    return {
      ...
      institutionalOwnership:
        fundamentals?.shareholding?.institutional ??
        unavailable("institutional", "Institutional % unavailable from NSE SHP / Yahoo"),
