...
async function fetchPeerSnapshot(symbol) {
  ...
  return {
    ...
    revenue: unavailable("revenue", "Peer fundamentals loaded on the institutional research terminal"),
    profitGrowth: unavailable("profitGrowth", "Peer fundamentals loaded on the institutional research terminal"),
    margins: unavailable("margins", "Peer fundamentals loaded on the institutional research terminal"),
    roe: unavailable("roe", "Peer fundamentals loaded on the institutional research terminal"),
    roce: unavailable("roce", "Peer fundamentals loaded on the institutional research terminal"),
    peRatio: unavailable("peRatio", "Peer fundamentals loaded on the institutional research terminal"),
    pbRatio: unavailable("pbRatio", "Peer fundamentals loaded on the institutional research terminal"),
    marketCap: unavailable("marketCap", "Peer fundamentals loaded on the institutional research terminal"),
    debtMetrics: unavailable("debt", "Peer fundamentals loaded on the institutional research terminal"),
    earningsGrowth: unavailable("earningsGrowth", "Peer fundamentals loaded on the institutional research terminal"),
...
async function buildCompetitorComparison(symbol, companyName) {
  ...
  if (!peers.length) {
    return {
      available: false,
      message: `No verified competitor mapping for ${companyName}. Add peers in competitors.json.`,
      peers: [],
    };
  }
  ...
  return {
    ...
    message: verified.length
      ? `Compared against ${verified.length} listed peers using verified Yahoo prices and technicals. Full peer fundamentals are on the research terminal.`
      ...
      rows: noNullRows(
        [
          ...
          ...verified.map((p) => [
            ...
            p.trend,
            p.rsi != null ? Number(p.rsi).toFixed(1) : null,
            val(p.revenue),
            val(p.roe),
            val(p.peRatio),
          ]),
