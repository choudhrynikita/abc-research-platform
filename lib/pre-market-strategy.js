...
const FILL_AT_OPEN = "Fill CE/PE from the live NSE chain at the next open — last-close map below is the plan until then.";
...
function annotateForPlanning(strategy, marketStatus, chainMeta) {
  ...
  return {
    ...
    premiumNote: hasReferencePremium
      ? "Reference premium from the last verified NSE close — not Monday's LTP. Recheck when the next session opens."
