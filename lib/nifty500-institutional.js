...
async function fetchEnrichedQuote(item) {
  try {
    ...
    const base = {
      ...
      roce: fd.roce ?? unavailable("roce", "ROCE unavailable from current feed"),
      ...
      epsGrowth: fd.earningsTrend ?? unavailable("epsGrowth", "EPS growth unavailable"),
      ...
      pegRatio: unavailable("peg", "PEG ratio requires licensed fundamentals feed"),
      evEbitda: unavailable("evEbitda", "EV/EBITDA requires licensed fundamentals feed"),
    ...
    if (candles.length >= 30) {
      ...
      base.technicals = {
        ...
        vwap: unavailable("vwap", "VWAP requires intraday exchange feed"),
        superTrend: unavailable("superTrend", "SuperTrend requires licensed TA feed"),
        cci: unavailable("cci", "CCI series unavailable in current indicator set"),
        ichimoku: unavailable("ichimoku", "Ichimoku requires extended indicator module"),
        parabolicSar: unavailable("parabolicSar", "Parabolic SAR requires extended indicator module"),
        stochasticRsi: unavailable("stochasticRsi", "Stochastic RSI requires extended indicator module"),
        mfi: unavailable("mfi", "MFI requires intraday volume feed"),
        obv: unavailable("obv", "OBV series unavailable in current indicator set"),
        pivotLevels: unavailable("pivot", "Pivot levels require exchange session data"),
        fibonacci: unavailable("fib", "Fibonacci retracement requires manual anchor selection"),
      };
