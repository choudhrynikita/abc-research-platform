...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/funds", label: "Mutual Funds & ETFs", hint: "Nifty BeES, index ETFs, AMFI NAVs", icon: "funds" },
      { href: "/commodities", label: "Commodities", hint: "Gold, silver, crude, gas, copper", icon: "commodities" },
    ],
  },
  {
    label: "Learn",
