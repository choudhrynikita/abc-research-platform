...
function buildFromYahoo(rawData) {
  ...
  const nseShareholdingNote =
    "Full NSE/BSE shareholding pattern (promoter / FII / DII categories) requires licensed exchange feed — not fabricated. Yahoo ownership % shown only when quoteSummary provides majorHoldersBreakdown.";
  ...
  return {
    ...
    shareholding: {
      ...
      // NSE-specific categories remain unavailable without licensed feed
      promoter: unavailableField("Promoter holding requires NSE/BSE shareholding feed — never estimated"),
      fii: unavailableField("FII holding requires NSE/BSE shareholding feed — never estimated"),
      dii: unavailableField("DII holding requires NSE/BSE shareholding feed — never estimated"),
      public: unavailableField("Public holding requires NSE/BSE shareholding feed — never estimated"),
      message: nseShareholdingNote,
      source: "Yahoo majorHoldersBreakdown when available; NSE categories never invented",
    },
    valuation: {
      peRatio,
      forwardPe,
