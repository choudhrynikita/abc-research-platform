...
const NA_MSG = "Verified data is currently unavailable.";
const NA_CONFIRM = "This information could not be confirmed from verified sources.";
const NA_INSUFFICIENT = "I don't have sufficient verified market data to answer that accurately.";
