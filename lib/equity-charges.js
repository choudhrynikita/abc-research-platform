...
const CHARGES_AS_OF = "2026-04-01";
...
function computeOptionLegCharges({
  ...
  // STT on sale of an option in securities: 0.15% of option premium (seller),
  // Finance Act 2026 / NSE FATAX circular, effective 1 Apr 2026 (was 0.10% to 31 Mar 2026).
  const stt = isSell ? Number((turnover * 0.0015).toFixed(2)) : 0;
