...
function computeOptionLegCharges({
  ...
  // STT on equity options: typically levied on sell side of premium turnover.
  // Rate 0.1% of option premium on sell (exchange convention).
  const stt = isSell ? Number((turnover * 0.001).toFixed(2)) : 0;
