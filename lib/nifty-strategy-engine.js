...
function attachOptionsDossier(strategy, context) {
  ...
  const backtest = {
    available: false,
    reason:
      "Backtest could not be completed — historical multi-leg option premium series is not provided by verified free feeds. Equity SMA rule backtests apply only to cash equity screens.",
    samples: 0,
    assumptions: [
      "Would require historical NSE option tick/premium series for each leg",
      "Never invent win rates or success percentages for options strategies",
    ],
  };
