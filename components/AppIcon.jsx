const PATHS = {
  ...
  brief: <><path d="M6 4.5h9l3 3V19.5H6z" /><path d="M15 4.5v3h3" /><path d="M9 11h6" /><path d="M9 14h6" /><path d="M9 17h4" /><path d="m18 11 1.2 2.3L21.5 14.5l-2.3 1.2L18 18l-1.2-2.3-2.3-1.2 2.3-1.2Z" /></>,
